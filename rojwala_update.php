...
error_reporting(0);
$id=$_GET["sid"];
$sql="SELECT * FROM rojwala_master WHERE id=$id";
...
<div class="col-md-12">
  <div class="card">
    <h5 class="card-header">Update Rojwala Majdur Details</h5>
    <div class="card-body">
      <form action="rojwala_update.php" method="post">
  <div class="mb-3">
...
if (isset($_POST['submit'])) {
  ...
  $upd="UPDATE rojwala_master SET name='$name',address='$address',mobile='$mobile1' WHERE id=$id";
  $r=mysqli_query($con,$upd);
  if ($r==true) {
    ?>
    <script type="text/javascript">
      alert("rojwala Majdur details updated successfully.");
