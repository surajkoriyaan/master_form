...
include("db.php");
$id=$_GET["sid"];
$sql="SELECT * FROM thekedar_master WHERE id=$id";
...
<div class="col-md-12">
  <div class="card">
    <h5 class="card-header">Update Thekedar Details</h5>
    <div class="card-body">
      <form action="thekedar_update.php" method="post">
  <div class="mb-3">
...
if (isset($_POST['submit'])) {
  ...
  $upd="UPDATE thekedar_master SET name='$name',address='$address',mobile1='$mobile1',mobile2='$mobile2' WHERE id=$id";
  $r=mysqli_query($con,$upd);
  if ($r==true) {
    ?>
    <script type="text/javascript">
      alert("thekedar details updated successfully.");
