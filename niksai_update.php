...
error_reporting(0);
$id=$_GET["sid"];
$sql="SELECT * FROM niksai_master WHERE id=$id";
...
<div class="col-md-12">
  <div class="card">
    <h5 class="card-header">Update Niksai Majdur Details</h5>
    <div class="card-body">
      <form action="niksai_update.php" method="post">
  <div class="mb-3">
...
if (isset($_POST['submit'])) {
  ...
  $upd="UPDATE niksai_master SET name='$name',address='$address',mobile='$mobile1' WHERE id=$id";
  $r=mysqli_query($con,$upd);
  if ($r==true) {
    ?>
    <script type="text/javascript">
      alert("Niksai Majdur details updated successfully.");
