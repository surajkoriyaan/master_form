...
error_reporting(0);
$id=$_GET["sid"];
$sql="SELECT * FROM party_master WHERE id=$id";
...
<div class="col-md-12">
  <div class="card">
    <h5 class="card-header">Update party Details</h5>
    <div class="card-body">
      <form action="party_update.php" method="post">
  <div class="mb-3">
...
if (isset($_POST['submit'])) {
  ...
  $upd="UPDATE party_master SET name='$name',address='$address',mobile='$mobile1' WHERE id=$id";
